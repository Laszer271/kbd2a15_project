...
CREATE INDEX BOOK_BOOK_TYPE_FK_I ON BOOK (BOOK_TYPE_ID ASC);
...
USING INDEX 
(
    CREATE UNIQUE INDEX BOOK_TYPE_UK1 ON BOOK_TYPE (TYPE ASC) 
)
 ENABLE;
...
USING INDEX 
(
    CREATE UNIQUE INDEX CLIENT_UK2 ON CLIENT (EMAIL ASC) 
)
 ENABLE;
...
USING INDEX 
(
    CREATE UNIQUE INDEX CLIENT_UK1 ON CLIENT (PHONE_NUMBER ASC) 
)
 ENABLE;
...
USING INDEX 
(
    CREATE UNIQUE INDEX EMPLOYEE_UK1 ON EMPLOYEE (PHONE_NUMBER ASC) 
)
 ENABLE;
